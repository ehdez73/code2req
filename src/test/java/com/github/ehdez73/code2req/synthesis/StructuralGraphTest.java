...
import com.github.ehdez73.code2req.analyzer.event.listener.MethodCallInfo;
...
class StructuralGraphTest {
    ...
    void getEntryPointsReturnsCorrectIdentifiers() {
        ...
        assertEquals("POST /api/orders", entryPoints.get(0).identifier());
        assertEquals("fixedRate=5000", entryPoints.get(1).identifier());
    }

...
| 5 | **Phase 2 enrichment qualification rules** | `enrichment/domain/planner/rule/` (6 rule classes) | PRD says Phase 2 is "optional" but doesn't detail the planner/qualification framework, DAG orchestration, or orphan recovery |
